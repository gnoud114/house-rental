            ...
            <div className='w-3/5'>
                ...
                <div className='flex items-center my-5 justify-between'>
                    <div className=' flex items-center'>
                        <img src="https://res.cloudinary.com/debctrjed/image/upload/v1769458772/default-avatar-icon_ulpdeg.jpg" alt="avatar" className='w-[30px] h-[30px] object-cover rounded-full' />
                        <p>{user?.name}</p>
                    </div>
